...
<div class="inner">
    ...
    <div style="text-align:-webkit-center;">
      ...
      <br>
    <h1 class="form-top-title" style="text-indent:0px; text-align: center; font-size:25px;"><span style="color: #002affff;">펭귄통신</span><br>인터넷 신규가입•변경<span style="color: #002affff;"><br>46만원 + @비밀지원금</span><br>지금 바로 문의하기</h1>
    <div class="form-box-inner">
        ...
        <form action="" id="form_e11" method="POST" target="hidden_iframe11" onsubmit="setTimeout(hoa, 1500); submitted=true;"> <!-- ★★폼 제출버튼 클릭하면, 1.5초간 기다리며 구글폼으로 먼저 들어간뒤 hoa(); 함수가 실행되어 땡큐페이지로 넘어감(25.07.15)★★ -->
          <input type="hidden" name="entry.1661081262" value="유입매체">
            ...
            <br>
                <table class="form-box-tb">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='text' name='entry.1091882026' id='name' class="form-control" placeholder="이름" maxlength="4">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='text' name='entry.508050488' id='phone' class="form-control" placeholder="휴대폰번호" maxlength="11">
                        </td>
                    </tr>
                    <!--<tr>
                        <th>원하는 차종</th>
                    ...
                    <tr>
                        <th>희망통신사</th>
                        <td>
                            <select name="entry.1683832180" id='Internet' class="form-control" placeholder="현재 조건">
                                <option value="가입희망 통신사를 선택하세요" selected disabled>가입희망 통신사를 선택하세요
                                <option value='SK'>SK</option>
                                <option value='LG'>LG</option>
                                <option value='KT'>KT</option>
                                <option value='SKB'>SKB</option>
                                <option value='LG헬로비전'>LG헬로비전</option>
                                <option value='스카이라이프'>스카이라이프</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th>설치사유</th>
                        <td>
                            <select name="entry.1908728649" id='Reason' class="form-control" placeholder="현재 조건">
                                <option value="약정만료 또는 신규만 신청가능합니다." selected disabled>약정만료 또는 신규만 신청가능합니다.
                                    <option value='약정만료'>약정만료</option>
                    ...
                    <!--<tr>
                        <th>확인사항</th>
                        <td>
                            <textarea name='entry.1470172621' id='message' class="form-control" placeholder="45분 풀코스 1:1 프리미엄 모락케어 체험을 위한 고급앰플비 23,500원외 전액무상으로 지원됩니다. 확인하셨습니까? \n예시답변) 네, 네 확인했습니다." style="min-height:100px"></textarea>
                        </td>
                    </tr>-->
