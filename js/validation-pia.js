$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfAYBeqLhpUtjtnJ8jwBgFeFrWwDiZJ_oMYlM2aA3LktGIkdA/formResponse");
                    ...
                    if(regex.test(id) && id.length == 2 && id >=23 && id <56)
                    {
                        ...
                        if( position != null )
                        {
                            ...
                            else
                            {
                                $('#send_message').css({transition:"1s"});
                                $('#send_message').prop("disabled", true);
                                $('#send_message').prop("value", "문의 사항을 적어주세요.");
                                $('#send_message').css({background:"#595959"});
                                $('#send_message').css({cursor:"default"});        
                            }
