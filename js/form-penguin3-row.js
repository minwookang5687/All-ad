            ...
            <br>
                <table class="form-box-tb">
                    ...
                    <tr>
                        <th>확인사항</th>
                        <td>
                            <textarea name='entry.1470172621' id='message' class="form-control" placeholder="최대 90만원 통신비 무료지원을 위해 현재 자취중인 가구의 인터넷 변경시 더 저렴한 인터넷 요금제와 최대 90만원 통신비 현금수령 절차를 함께 안내해드립니다. \n\n예시답변) 네 알겠습니다 / 네 확인했습니다." style="min-height:100px"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>희망사항</th>
